//todo Задача 1 - Data/model
// -Создать package – model. Работу продолжаем в нем
// -Реализовать абстрактный класс User и его наследники Student и Teacher. Родитель имеет в себе общие данные
//  (пример: фио, год рождения и тд), а наследники собственные параметры (какие, по вашему выбору – Пример:
//  studentId для Student, teacherId для Teacher)

//todo Задача 2 - Service
...
public class Main {
    public static void main(String[] args) {
        ...
        controller.createStudent("Анютина", "Анна", "Петровна");
        controller.createTeacher("Иванов", "Иван", "Иванович");

        controller.viewStudents();
        controller.viewTeachers();
        System.out.println();
        controller.viewStudyGroup(controller.createStudyGroup(12));
